        ...
        <div className="p-6">
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <div className="mb-4">
              ...
              <textarea id="description" className="w-full p-2 border border-green-500 rounded-md" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Deskripsi Singkat Panduan" />
            </div>
            ...
            <div className="mb-4">
              ...
              <textarea id="content" className="w-full p-2 border border-green-500 rounded-md" value={content} onChange={(e) => setContent(e.target.value)} placeholder="Isi Panduan" />
            </div>
            ...
            <div className="mb-4">
              ...
              <textarea id="description" className="w-full p-2 border border-green-500 rounded-md" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Tips & Trick Panduan" />
            </div>
